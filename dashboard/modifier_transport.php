...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $demandeur = $_POST['id_cText'];
    $depart = $_POST['depart'];
    $arrivee = $_POST['arrivee'];
    $marchandise = $_POST['marchandise'];
    $tarif = $_POST['tarif'];
    $id_c = $_POST['id_c'];
    $sql = "INSERT INTO Transport (Date, vehicule, demandeur, depart, arrivee, marchandise, Tarif,id_c)
            VALUES ('$date', '$vehicule', '$demandeur', '$depart', '$arrivee', '$marchandise', $tarif,$id_c)";
                                ...
                                <form method="post" action="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="vehicule" placeholder="Vehicule" required>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                ...
                                document.addEventListener("DOMContentLoaded", function () {
                                    ...
                                    hiddenInput.value = selectedOption.text;
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="arrivee" placeholder="Arrivee" required>
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <label for="marchandise">Marchandise:</label>
                                            <input type="text" class="form-control" name="marchandise" placeholder="Marchandise" required>
                                        </div>
                                        <div class="col-md-2 mb-3">
    ...
    $(document).ready(function () {
        ...
        $('#editButton').on('click', function () {
            ...
            if (selectedRow.length > 0) {
                ...
                $('#editModal #editVehicule').val(data.vehicule);
                $('#editModal #editDemandeur').val(data.demandeur);
                $('#editModal #editDepart').val(data.depart);
                $('#editModal #editArrivee').val(data.arrivee);
                $('#editModal #editMarchandise').val(data.marchandise);
                $('#editModal #editTarif').val(data.Tarif);
                ...
                $('#saveChangesButton').on('click', function () {
                    ...
                    var updatedData = {
                        'id': id,
                        'Date': $('#editDate').val(),
                        'vehicule': $('#editVehicule').val(),
                        'demandeur': $('#id_cTextt').val(),
                        'depart': $('#editDepart').val(),
                        'arrivee': $('#editArrivee').val(),
                        'marchandise': $('#editMarchandise').val(),
                        'Tarif': $('#editTarif').val(),
                        'id_c': $('#id_cc').val()
                    };
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="form-group">
                        <label for="editVehicule">Vehicule:</label>
                        <input type="text" class="form-control" id="editVehicule" name="editVehicule">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="editDepart">Depart:</label>
                        <input type="text" class="form-control" id="editDepart" name="editDepart">
                    </div>

                    <div class="form-group">
                        <label for="editArrivee">Arrivee:</label>
                        <input type="text" class="form-control" id="editArrivee" name="editArrivee">
                    </div>

                    <div class="form-group">
                        <label for="editMarchandise">Marchandise:</label>
                        <input type="text" class="form-control" id="editMarchandise" name="editMarchandise">
                    </div>
