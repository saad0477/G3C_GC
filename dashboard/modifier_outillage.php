...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO outillage (chantier,date,design, U, Qte, PU,id_c)
            VALUES ('$chantier','$date','$design', '$U', '$Qte', '$PU','$id_c')";
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <h1 class="mt-4">Outillage</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Outillage</li>
                        </ol>
</div>
...
console.log(updatedData);
        ...
        $('#editButton').on('click', function () {
            ...
            if (selectedRow.length > 0) {
                ...
                <?php $selectedchantierid= ''?>    data.id_c          <?php  ;  ?>
