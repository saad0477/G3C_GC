...
.form {
    ...
    ?>
       ...
       <!-- <input type="hidden" id="id_e" value='7'> -->
       <select id="id_e" class="form-select form-select-lg mb-3">
    ...
    <button class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="checkSelections()">Ajouter Préstation</button>
...
function submitForm() {
    ...
    function closeModal() {
      ...
      var select1 = document.getElementById("id_e");
      ...
      if (select1.value !== "" && select2.value !== "" && select3.value !== "") {
        ...
        alert("Vous avez pas rempli tout les champs.");
